...
const copy = {
  ...
  fa: {
    ...
    description:"با iQlinic اطلاعات بیمار را یکپارچه کنید، پیشنهاد نوبت و اولویت پیگیری را بررسی کنید و در کنار نرم‌افزار فعلی کلینیک، با تأیید تیم تصمیم بگیرید. مشاهده دمو.",
    og:"نرم افزار هوش مصنوعی کلینیک دندانپزشکی؛ از داده تا اقدام",
    kicker:"نرم‌افزار هوش مصنوعی برای کلینیک دندانپزشکی",
    h1:"نرم‌افزار هوش مصنوعی کلینیک دندانپزشکی", h1e:"برای پذیرش، پیشنهاد نوبت و پیگیری درمان.",
    ...
    live:"نمونه نمایشی پیشنهاد برای تیم پذیرش", cardSmall:"بررسی تداوم درمان بیمار", cardTitle:"طرح درمان، نوبت بعدی ندارد",
    ...
    intent:"برای انتخاب کاربرد اول، <a href='/fa/insights/dental-clinic-ai-receptionist/'>راهنمای پذیرش هوشمند دندانپزشکی</a>، <a href='/fa/insights/ai-dental-scheduling/'>نوبت‌دهی هوشمند</a> و <a href='/fa/insights/ai-dental-practice-management/'>مدیریت کلینیک با هوش مصنوعی</a> را بخوانید. سپس <a href='/fa/demo/'>دموی تعاملی iQlinic</a> را ببینید و یک گردش‌کار مشخص برای ارزیابی انتخاب کنید.",
...
<body class="solution-page" dir="${c.dir}">
  ...
  <main>
    ...
    ${lang === 'fa' ? "<section class=\"solution-section shell\" id=\"pilot-checklist\"><div class=\"solution-heading\"><h2>در دموی پذیرش و نوبت‌دهی چه چیزی را بررسی کنید؟</h2><p>یک سناریوی نمونه بدون اطلاعات هویتی بیمار انتخاب کنید. هدف دمو، روشن‌شدن گردش‌کار و محدودیت‌هاست؛ نتیجه مالی یا درمانی را باید در پایلوت اندازه‌گیری کرد.</p></div><div class=\"fit-grid\"><article><h3>پیشنهاد نوبت قابل اجرا</h3><p>ساعت حضور پزشک، تعطیلی، زمان استراحت و مدت خدمت را مشخص کنید. بررسی کنید پیشنهاد با ظرفیت واقعی سازگار باشد و دلیل انتخاب زمان برای منشی روشن بماند.</p></article><article><h3>تداوم درمان بیمار</h3><p>برای بیماری که طرح درمان باز دارد، آخرین مراجعه و نوبت بعدی را کنار هم ببینید. سابقه درمان و ترجیح بیمار باید پیش از تأیید پیشنهاد بررسی شوند.</p></article><article><h3>اندازه‌گیری نتیجه</h3><p>زمان یافتن نوبت، پیشنهادهای نامعتبر، پذیرش پیشنهاد توسط منشی و تکمیل پیگیری را با روش فعلی مقایسه کنید. دوره و گروه بیماران باید از ابتدا مشخص باشند.</p></article></div><div class=\"risk-note\"><strong>هزینه و امکان اتصال</strong><p>برای برآورد، نام نرم‌افزار فعلی، تعداد کاربران پذیرش، ساختار نوبت‌دهی و کاربرد موردنظر را اعلام کنید. سازگاری اتصال و دامنه اجرا باید پیش از توافق بررسی شود؛ این صفحه قیمت ثابت یا اتصال تضمینی به همه نرم‌افزارها اعلام نمی‌کند.</p></div><p><a class=\"button primary\" href=\"/fa/demo/\">مشاهده دموی تعاملی پذیرش و تصمیم‌یار</a></p></section>" : ''}
